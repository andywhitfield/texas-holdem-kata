...
public class Hands {
	...
	public static List<KeyValue<Integer, Collection<Card>>> existSameValuedCards(Iterable<Card> cards, int numberOfSameValuedCards, SameValueMatchType matchType) {
		...
		Collection<KeyValue<Integer, Collection<Card>>> sameValuedCards = Iterables.where(Iterables.keyValues(groupedByValue), new HavingNumberCards<Integer>(numberOfSameValuedCards, matchType));
